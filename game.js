...
const catImages = ["catImage.png", "catImage1.png", "catImage2.png", "catImage3.png"];
catImage.src = catImages[0];

var backgroundImage = new Image();
const backgroundImages = ["space.png", "sky.png", "city.jpg", "snowy.png"];
backgroundImage.src = backgroundImages[0];

var catWidth = catImage.naturalWidth/5;
var catHeight = catImage.naturalHeight/5;
...
cat.prototype.update = function () {
    if( this.y <= 0 || this.y+this.height >= game.gameFieldHeight() ) {
        this.yDir *= -1;
		while(this.y <= 0 || this.y+this.height >= game.gameFieldHeight()) {
			this.y += this.yDir;
		}
    }
	if( this.x <= 0 || this.x+this.width >= game.gameFieldHeight() ) {
        this.xDir *= -1;
		while(this.x <= 0 || this.x+this.width >= game.gameFieldHeight()) {
			this.x += this.xDir;
		}
    }
};
...
var renderer = (function () {
    ...
    function _drawcat(context, cat) {
        context.drawImage(catImage,cat.x,cat.y,catWidth,catHeight);
    }
